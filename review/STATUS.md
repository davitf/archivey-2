...
|--------|---------------------|----------------------|-------------------|
| `debt-ledger/` | yes (2026-07-20) | pay-list D2/D3/T1/T2/T3/D4/T7 open; **D1/D5/D6 done**; **Q1/Q2 decided**; Q3–Q5 open | no |
| `performance/` | yes (#134 + follow-ups) | P3–P5 done; listing L0–L3 + peers; residual band miss **accepted as aspirational** (debt-ledger Q2 (b)); wall enforcement **Q2 decided** (drift gate); **Q4 open** | no |
...
| **Q2** | ZIP listing above band: L5 vs publish honest number | **decided** — (b) aspirational bands + measured table; L5 → `IDEAS.md` |
