...
|---|------|-------|--------|---------|
| **D1** | VISION/philosophy/costs still publish **≤1.3× for open/list** — falsified by own measurements; maintainer's Q1 re-scoping (peer-ratio bands) never reached the docs | `VISION.md:74-76`; `review/performance/QUESTIONS.md` Q1 | **F3** | **DONE** (2026-07-20) — bands aspirational + measured table in `docs/costs.md` (Q2 (b)); L5 → `IDEAS.md` |
...
| **DD1/DD3** | Perf **Q2** (wall enforcement) + ZIP listing above its own band (L5 or honest number) | `review/performance/` | **F3** | **DECIDED** — Q1 (a) drift; Q2 (b) aspirational bands |
...
1. ~~**D1** — re-word the perf claim~~ **done** (2026-07-20; Q1/Q2 decided).
