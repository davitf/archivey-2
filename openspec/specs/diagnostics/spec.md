...
Diagnostics turn advisory library events (formerly log-only warnings) into immutable,
policy-controlled data with stable codes, typed JSON-safe context, bounded retention,
and lifecycle-aware aggregation across detection, readers, streams, and extraction.
