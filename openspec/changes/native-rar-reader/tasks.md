...
- [x] 1.4 SFX prefix scan (≤2 MiB for `RAR_ID` / `RAR5_ID`); accept RAR 1.5 / 2.x extract versions (≤ 20) — data via `unrar`
...
- [x] 4.3 Header-encrypted RAR5, Blake2sp-only, stored M0, multi-volume, RAR 1.5/2.x accept, non-RARLAB `unrar` rejection
