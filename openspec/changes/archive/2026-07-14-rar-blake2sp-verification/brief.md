...
**Status:** Complete — all eleven tasks done; ready to archive. Depends on nothing. Behavior change (a corrupt member now raises instead of reading clean), but no API break. Effort: small to medium.
