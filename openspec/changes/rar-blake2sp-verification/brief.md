...
**Status:** In progress — implementation done; three-config verify remaining. Depends on nothing. Behavior change (a corrupt member now raises instead of reading clean), but no API break. Effort: small to medium.
